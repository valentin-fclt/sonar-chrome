...
const Popup = () => {
  ...
  const websiteIsTrackedBySonar = trackedDomainsList.includes(currentDomain);
          ...
          <Box>
            ...
            {websiteIsTrackedBySonar ? (
              ...
              >
                ...
                <Typography>
                  This website <b>IS</b> tracked by Sonar.
                </Typography>
              </Stack>
            ) : (
              <Stack
              ...
              >
                ...
                <Typography>
                  This website <b>IS NOT</b> tracked by Sonar.
                </Typography>
              </Stack>
            )}
          </Box>
